...
public class FrontController extends HttpServlet {
	...
	protected void doProcess(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(command.equals("/Main.park")) {
			...
			forward.setPath("./reservation1/main.jsp");
		...
		//예약
			...
			forward = new ActionForward();
			forward.setPath("./reservation1/reservationForm.jsp");
			forward.setRedirect(false);
		...
		// 예약후 결제페이지
		else if(command.equals("/Test.park")) {
			System.out.println("C: /Test.park 호출");
			
			forward = new ActionForward();
			forward.setPath("./reservation1/test.jsp");
			forward.setRedirect(false);
		}
