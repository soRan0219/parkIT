...
<body>
	...
	<div class="join_content">
		<form action="./MemberJoinAction.me" id="myform" method="post" onsubmit="return checkData();">
	<!-- 아이디, 비밀번호 입력 -->
		<div class="row_group">
			<div class="join_row">
				<p>
...
<!-- 		class="privacyAgreeCheckBox"  -->
		...
		<script type="text/javascript">
		  function showAgreementDetails() {
		    window.open('MemberJoinAgree.me', '_blank', 'width=500, height=500, top=' + ((screen.height - 500) / 2) + ', left=' + ((screen.width - 500) / 2));
		  }
		</script>
