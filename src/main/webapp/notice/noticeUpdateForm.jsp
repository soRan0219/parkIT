...
<body>
	...
	<div>
		내용 : <textarea rows="5" cols="10" name="noticeContents" placeholder="내용을 입력하세요." >${param.noticeContents }</textarea>
	</div>
	
	<div>
		첨부파일 : <input type="file" name="noticeFile" value="${param.noticeFile }">
	</div>
